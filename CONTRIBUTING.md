...
- **GitHub:** https://github.com/tunacosgun/openclaw
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@tunacosgun](https://x.com/tunacosgun) / [@tunacosgun](https://x.com/openclaw)

## Maintainers

- **Tunahan Coşgun** - Benevolent Dictator
  - GitHub: [@tunacosgun](https://github.com/tunacosgun) · X: [@tunacosgun](https://x.com/tunacosgun)
...
2. **New features / architecture** → Start a [GitHub Issue](https://github.com/tunacosgun/openclaw/issues/new/choose) or ask in Discord first. Most features are not accepted and should be third party plugins instead using our plugin SDK.
...
- Do not submit test or CI-config fixes for failures already red on `main` CI. If a failure is already visible in the [main branch CI runs](https://github.com/tunacosgun/openclaw/actions), it's a known issue the Maintainer team is tracking, and a PR that only addresses those failures will be closed automatically. If you spot a _new_ regression not yet shown in main CI, report it as an issue first.
...
Check the [GitHub Issues](https://github.com/tunacosgun/openclaw/issues) for
["good first issue"](https://github.com/tunacosgun/openclaw/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
...
Still interested? Email contributing@tunacosgun.ai with:
...
For issues that don't fit a specific repo, or if you're unsure, email **security@tunacosgun.ai** and we'll route it.
