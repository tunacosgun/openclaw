...
| `~/.tunacosgun/openclaw.json` | **Behavior config** — models, channels, policies | Model selection, WhatsApp allowlists, agent settings                |
...
- `~/.tunacosgun/openclaw.json` is available at `/home/node/.tunacosgun/openclaw.json` — the gateway watches it and hot-reloads most changes
