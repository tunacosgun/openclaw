...
Use this skill when processing alerts from `https://github.com/tunacosgun/openclaw/security/secret-scanning`.
...
[
  {
    ...
    "location_url": "https://github.com/tunacosgun/openclaw/issues/63101#issuecomment-xxx",
