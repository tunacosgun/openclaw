...
[https://github.com/tunacosgun/openclaw/blob/main/apps/macos/README.md](https://github.com/tunacosgun/openclaw/blob/main/apps/macos/README.md)
...
2. If that fails, change the `BUNDLE_ID` temporarily in [`scripts/package-mac-app.sh`](https://github.com/tunacosgun/openclaw/blob/main/scripts/package-mac-app.sh) to force a "clean slate" from macOS.
