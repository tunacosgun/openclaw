...
You can override this in `~/.tunacosgun/openclaw.json`:
...
All logging configuration lives under `logging` in `~/.tunacosgun/openclaw.json`.

```json
{
  "logging": {
    "level": "info",
    "file": "/tmp/tunacosgun/openclaw-YYYY-MM-DD.log",
    "consoleLevel": "info",
    "consoleStyle": "pretty",
